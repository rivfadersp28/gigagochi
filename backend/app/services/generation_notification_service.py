...
from app.services.telegram_client import mini_app_keyboard, send_message, send_video
...
TRAVEL_READY_CAPTION = "Я вернулся из путешествия! Смотри, как всё прошло."
